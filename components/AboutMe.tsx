...
const stack = [
  '[Tu habilidad o herramienta #1]',
  '[Tu habilidad o herramienta #2]',
  '[Tu habilidad o herramienta #3]',
  '[Tu habilidad o herramienta #4]',
  '[Tu habilidad o herramienta #5]',
];
      ...
      <div className="container">
        ...
        >
          <h2 style={{ fontSize: '3rem', fontWeight: '700', fontFamily: 'Space Grotesk' }}>
            QUIÉN <span style={{ color: 'var(--foreground-secondary)' }}>SOY</span>
          </h2>
        </motion.div>
        ...
        >
          ...
          <motion.div variants={cardVariant} className="bento-card bento-main">
            <span className="bento-label">{"// HISTORIA"}</span>
          ...
          <motion.div variants={cardVariant} className="bento-card bento-philosophy">
            <span className="bento-label">{"// FILOSOFÍA"}</span>
            ...
            <p style={{ color: 'var(--foreground-secondary)', marginTop: '1rem', fontSize: '0.9rem', lineHeight: '1.7' }}>
              {/* ✏️ PERSONALIZAR: añade un principio o idea que defina tu forma de trabajar */}
              [Un principio que guíe tu forma de trabajar o crear.]
            </p>
          </motion.div>

          {/* Tarjeta 3 — Garantía */}
          <motion.div variants={cardVariant} className="bento-card bento-guarantee">
            <span className="bento-label">{"// PROPUESTA"}</span>
            <div style={{ marginTop: '1rem' }}>
              <div style={{ fontSize: '3.5rem', fontFamily: 'Space Grotesk', fontWeight: '700', lineHeight: '1' }}>
                ✦
              </div>
              {/* ✏️ PERSONALIZAR: tu propuesta de valor o diferenciador clave */}
              ...
              <div style={{ fontSize: '0.85rem', color: 'var(--foreground-secondary)', marginTop: '0.5rem', lineHeight: '1.6' }}>
                [Describe brevemente qué ofreces o qué te diferencia.]
              </div>
            </div>
          </motion.div>
          ...
          <motion.div variants={cardVariant} className="bento-card bento-stack">
            ...
            <span className="bento-label">{"// ESPECIALIDADES"}</span>
